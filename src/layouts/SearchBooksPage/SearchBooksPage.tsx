...
export const SearchBooksPage = () => {
    ...
    let lastItem: number = booksPerPage * currentPage <= totalAmountOfBooks ? booksPerPage * currentPage : totalAmountOfBooks;
                    ...
                    </div>
                    {
                        totalAmountOfBooks>0 ?
                            <>
                                ...
                                <p>
                                    {indexOfFirstBook + 1} to {lastItem} from {totalAmountOfBooks} items
                                </p>
                                {
                                    books.map(book => (
                            ...
                            <div className="m-5">
                                ...
                                <a type="button" className="btn main-color btn-md px-4 me-md2 fw-bold text-white" href="#">Library services</a>
                            </div>
                    }
                    {
                        totalPages>1 &&
