                    ...
                    <form method="POST">
                        <div className="row">
                            ...
                            <div className="col-md-3 mb-3">
                                ...
                                >
                                    <li><a onClick={()=>setCategory("FE")} className="dropdown-item">Front end</a></li>
                                    <li><a onClick={()=>setCategory("BE")} className="dropdown-item">Back end</a></li>
                                    <li><a onClick={()=>setCategory("Data")} className="dropdown-item">Data</a></li>
                                    <li><a onClick={()=>setCategory("DevOps")} className="dropdown-item">Dev-Ops</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <input  type="file"
                                onChange={e => base64ConverstionForImages(e)} 
                        />
                        <div>
                            <button type="button"
