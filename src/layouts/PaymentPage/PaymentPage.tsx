    ...
    useEffect(()=>{
        const fetchFees = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                const paymenyResponse = await fetch(url,requestOptions);
                console.log(paymenyResponse);
                if (!paymenyResponse.ok) {
                    throw new Error("Something went wrong.");
                }
                const paymentResponseJson = await paymenyResponse.json();
        ...
        <div className="container">
            {
                ...
                <div className="card mt-3">
                    ...
                    <div className="card-body">
                        ...
                        <button disabled={submitDisabled} type="button" onClick={checkout} className="btn btn-md main-color text-white mt-3">Pay fees</button>
                    </div>
                </div>
            }
            {
